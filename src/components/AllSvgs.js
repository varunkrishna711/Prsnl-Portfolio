...
export const LinkedIn = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.95 0 54.25S24.09 0 53.79 0s53.79 24.15 53.79 53.75S83.48 108.1 53.79 108.1zM447.9 448h-92.68V302.4c0-34.7-.7-79.3-48.29-79.3-48.29 0-55.69 37.7-55.69 76.7V448h-92.68V148.9h88.94v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"
      />
    </svg>
  );
};
...
export const LeetCode = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <rect x="2" y="2" width="20" height="20" rx="4" fill={props.fill} />
      <path
        d="M9.2 7.2 6.8 9.6c-.4.4-.4 1 0 1.4l2.4 2.4c.4.4 1 .4 1.4 0l2.4-2.4c.4-.4.4-1 0-1.4L10.6 7.2c-.4-.4-1-.4-1.4 0Zm5.2 0 2.4 2.4c.4.4.4 1 0 1.4l-2.4 2.4c-.4.4-1 .4-1.4 0l-2.4-2.4c-.4-.4-.4-1 0-1.4l2.4-2.4c.4-.4 1-.4 1.4 0Z"
        fill="#fff"
      />
      <path
        d="M10.2 15.8 8.8 14.4c-.4-.4-.4-1 0-1.4l1.4-1.4c.4-.4 1-.4 1.4 0l1.4 1.4c.4.4.4 1 0 1.4l-1.4 1.4c-.4.4-1 .4-1.4 0Z"
        fill="#fff"
      />
    </svg>
  );
...
export const Data = (props) => {
  return (
    <svg
      ...
      className="prefix__svg-inline--fa prefix__fa-chart-simple prefix__fa-w-20"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
      {...props}
    >
